  ...
  return (
    <form onSubmit={handleSubmit} id="payment-form" className="text-gray-600">
      ...
      <button
        ...
        className="w-full px-4 py-2 font-bold text-white transition bg-orange-500 rounded-md shadow hover:bg-orange-700 disabled:opacity-50 disabled:cursor-not-allowed"
      >
